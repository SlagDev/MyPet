...
class Duck:
    ...
    def load_images(self):
        self.move_left_images = [tk.PhotoImage(file='Images/duck-left.gif', format='gif -index %i' % i) for i in range(10)]
        self.move_right_images = [tk.PhotoImage(file='Images/duck-right.gif', format='gif -index %i' % i) for i in range(10)]
